...
1.Convert `absences` variable(numeric from 0 to 93) into categorical as follow: \
...
2.Convert all Math and Portuguese grades into categorical based on the following grading system for Portuguese school: \
```{r,echo=FALSE}
